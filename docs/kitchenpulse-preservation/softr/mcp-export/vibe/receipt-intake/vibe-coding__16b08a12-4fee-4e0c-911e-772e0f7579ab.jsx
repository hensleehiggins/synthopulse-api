...
export default function Block(props) {
  ...
  const subheadlineFallback = useTextSetting({
    ...
    label: "Subheadline",
    initialValue:
      "Upload vendor receipts and invoices so KitchenPulse can stage cost, inventory, and margin intelligence before anything touches live operating logic.",
  });
          ...
          >
            <div className="min-w-0">
              ...
              <div className="mt-6 grid gap-3 md:grid-cols-3">
                ...
                >
                  ...
                  >
                    Stage invoices, receipts, PDFs, or vendor files.
                  </div>
                </div>
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: "rgba(226,232,240,0.66)" }}
                  >
                    Extract vendor, totals, dates, and line items.
                  </div>
                </div>
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: "rgba(226,232,240,0.66)" }}
                  >
                    Approve before costs or inventory are trusted.
                  </div>
                </div>
              </div>
              ...
              >
                ...
                Built for AI parsing + approval workflows
              </div>
            </div>
            ...
            <div className="min-w-0">
              ...
              >
                ...
                >
                  Stage vendor costs before they affect inventory or margin.
                </div>
                ...
                >
                  Receipts land in review first. KitchenPulse can parse vendor,
                  dates, totals, and line items, but nothing updates costs,
                  inventory, beverage variance, or par logic until approved.
                </div>
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <div
                        ...
                        style={{ color: "rgba(226,232,240,0.66)" }}
                      >
                        Review and approve before downstream use.
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <div
                        ...
                        style={{ color: "#F8FAFC" }}
                      >
                        Cost + inventory foundation
                      </div>
                      <div
                        className="mt-0.5 text-xs"
                        style={{ color: "rgba(226,232,240,0.66)" }}
                      >
                        Build better margin confidence over time.
                      </div>
                    </div>
                  </div>
