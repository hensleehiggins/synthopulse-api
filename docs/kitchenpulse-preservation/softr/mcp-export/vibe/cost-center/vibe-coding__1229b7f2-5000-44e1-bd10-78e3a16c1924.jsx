...
export default function Block(props) {
  ...
  const subheadlineFallback = useTextSetting({
    ...
    label: "Subheadline",
    initialValue:
      "Track vendor cost movement, margin pressure, and ingredient-level changes from approved receipt signals before they become hidden profit leaks.",
  });
          ...
          >
            <div className="min-w-0">
              ...
              <div className="mt-6 grid gap-3 md:grid-cols-3">
                ...
                >
                  ...
                  >
                    Spot ingredient costs moving up or down.
                  </div>
                </div>
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: "rgba(226,232,240,0.66)" }}
                  >
                    See where cost changes may affect profit.
                  </div>
                </div>
                ...
                >
                  ...
                  <div
                    ...
                    style={{ color: "rgba(226,232,240,0.66)" }}
                  >
                    Support pricing, portions, features, and vendor talks.
                  </div>
                </div>
              </div>
              ...
              >
                ...
                Built from approved receipt cost signals
              </div>
            </div>
            ...
            <div className="min-w-0">
              ...
              >
                ...
                >
                  Turn receipt data into margin decisions.
                </div>
                ...
                >
                  Approved receipt lines become Cost Movement signals. KitchenPulse
                  tracks previous cost, latest cost, direction, severity, and
                  owner-ready guidance so cost changes are easier to act on.
                </div>
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <div
                        ...
                        style={{ color: "rgba(226,232,240,0.66)" }}
                      >
                        Find items where vendor costs are rising.
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <div
                        ...
                        style={{ color: "rgba(226,232,240,0.66)" }}
                      >
                        See where lower costs may create margin room.
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <div
                        ...
                        style={{ color: "rgba(226,232,240,0.66)" }}
                      >
                        Built from reviewed receipt lines, not raw uploads.
                      </div>
                    </div>
                  </div>
                </div>
